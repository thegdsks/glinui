...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/glinui/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/glinui/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/glinui/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/glinui/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/glinui/Projects/foobar/lib/utils")
})
