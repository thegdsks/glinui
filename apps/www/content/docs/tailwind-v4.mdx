---
title: Tailwind v4
description: How to use glinui/ui with Tailwind v4 and React 19.
---
...
<div className="flex gap-2 items-center mt-6">
  ...
  <Button asChild size="sm" variant="outline" className="rounded-lg">
    <a href="https://v4.glinui.com" target="_blank" rel="noopener noreferrer">
      See Demo
    </a>
  </Button>
</div>
...
- We're deprecating the `default` style. New projects will use `tailwind`.
...
I put together a demo with all the updated components here: https://v4.glinui.com

Take a look and test the components. If you find any bugs, please let me know on [GitHub](https://github.com/glinr-ui/ui).
...
One of the major advantages of using `glinui/ui` is that the code you end up with is exactly what you'd write yourself. There are no hidden abstractions.
...
```bash
npx glinui@latest add --all --overwrite
```
